...
const BlogRowCard = ({ blog }) => {
  return (
    ...
    >
      <img src={blog.coverPicture} alt="cover-pic" className="w-full h-28 md:h-40" />
      <div className="p-1 md:p-2 border-t-2">
        <h2 className="font-roboto font-bold text-dark-soft md:text-2xl lg:text-[16px]">
          {blog.title}
        </h2>
        <div className="flex justify-between flex-nowrap items-center mt-1 md:mt-2">
