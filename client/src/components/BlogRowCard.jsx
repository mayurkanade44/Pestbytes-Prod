...
const BlogRowCard = ({ blog }) => {
  return (
    <Link
      to={`/blog/${blog._id}`}
      className={`relative border-2 border-gray-300 h-44 min-w-[230px] cursor-pointer transition duration-200 ease-out md:h-64 md:w-[360px] md:hover:scale-105 `}
    >
      <img
      ...
      <div className="p-0.5 md:p-2 border-t-2">
        <h2 className="font-roboto text-[12px] font-bold text-dark-soft md:text-2xl lg:text-[16px]">
